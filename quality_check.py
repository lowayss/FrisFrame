...
def main() -> None:
    ...
    for filename in (
        ...
        "electron/camera-take-replay-ux.js",
        "electron/camera-take-browser-ux.js",
    ...
    for filename in (
        ...
        "tests/camera-take-path-core.test.cjs",
        "tests/physical-camera-take-context.test.cjs",
        "tests/physical-camera-take-browser-ux.test.cjs",
        "tests/physical-camera-take-replay-ux.test.cjs",
        ...
        "tests/birdseye-cad-edit-flow-contract.test.cjs",
