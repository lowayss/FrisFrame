  ...
  function buildTutorialSteps(serviceName = "FrisFrame") {
    return [
      ...
      },
      {
        ...
        title: "7. 소품별 행동 연결",
        body: "배우 속성에서 침대·소파·의자·탈것처럼 행동 위치가 있는 소품을 직접 선택하고, 행동과 위치를 정한 뒤 행동 적용을 누릅니다. 연결된 배우는 대상 소품을 따라 움직이고, 연결 해제로 다시 분리할 수 있습니다.",
        tryText: "배우 속성에서 행동 대상·행동·위치를 직접 고른 뒤 행동 적용을 눌러 지정한 자세와 위치를 확인하세요.",
      },
      {
        selector: ".timeline",
        workspace: "blocking",
      ...
      },
      {
        ...
        view: "3d",
        title: "9. 3D 프리비즈 확인",
        body: "3D에서는 배우·소품·카메라의 높이와 방향을 입체적으로 확인합니다. 이동·회전·포즈 모드로 대상을 편집하고, 오른쪽 아래 카메라 프레임에서 실제 렌즈에 들어오는 구도를 확인합니다.",
        tryText: "V로 2D·3D를 빠르게 전환하고, 드래그 중 Esc로 취소하거나 L로 선택 대상을 잠가 실수를 줄일 수 있습니다.",
      },
      {
        selector: "#exportMenu",
        workspace: "blocking",
        title: "10. 프리뷰와 내보내기",
        body: "현재 프레임, 시작·끝 프레임, 프리비즈 영상을 먼저 확인한 뒤 필요한 결과만 직접 저장합니다. 작업 중 자동 다운로드는 발생하지 않습니다.",
        tryText: "Seedance Video Reference로 넘기기 전 2D 동선 재생과 3D 카메라 프레임을 한 번씩 확인하세요.",
      },
      {
        title: "두 가지 시작 방식",
        body: "수동 작업은 컷 선택 → 화면비 → 배우·소품 → 카메라 → 키프레임 → 프리비즈 검토 순서로 진행합니다. MCP 보조 작업은 외부 비전 가능한 MCP 클라이언트가 이미지와 지시를 해석해 명시적인 무대·카메라·키프레임 명령을 보내며, 결과는 같은 프로젝트에서 그대로 수동 수정합니다. 어느 방식이든 마지막 결과는 Seedance Video Reference용 프리비즈 MP4입니다.",
        tryText: "데스크톱 설치본에서 MCP를 연결할 때는 앱 메뉴의 ‘도움말 → MCP 실행 경로 복사’로 실제 stdio 실행 경로를 얻을 수 있습니다.",
      },
    ];
  }
